...
def dingo-walk_args():
    ...
    parser = argparse.ArgumentParser(
        description="a parser to read the inputs of dingo-walk package \
         dingo-walk is a Python library for the analysis of \
        ...
        usage="%(prog)s [--help | -h] : help \n\n \
         The default method is to generate uniformly distributed steady states of the given model:\n\
           ...
           python -m dingo-walk -i path_to_my_model \n\n \
           2. or ask for more: \n \
           python -m dingo-walk -i path_to_my_model -n 2000 -s gurobi \n \
         \n\n\
         You could give a full dimensional polytope derived from a model by dingo-walk and saved to a `pickle` file:\n\
            python -m dingo-walk -poly path_to_pickle_file -n 1000 \n \
         \n\n \
         You could ask for FVA or FBA methods:\n \
           python -m dingo-walk -i path_to_my_model -fva True\n \
         \n\n\
    ...
    optional.add_argument(
        "--polytope",
        "-poly",
        help="the path to a pickle file generated by dingo-walk that contains a full dimensional polytope derived from a model. This file could be used to sample more steady states of a preprocessed metabolic network.",
        required=False,
        default=None,
        metavar="",
    )
    ...
    optional.add_argument(
        "--steady_states",
        "-st",
        help="A path to a pickle file that was generated by dingo-walk and contains steady states of a model.",
        required=False,
        default=None,
        metavar="",
    )
    ...
    optional.add_argument(
        ...
        "-mr",
        help="A path to a pickle file that was generated by dingo-walk and contains the names of the metabolites and the reactions of a model.",
        required=False,
        default=None,
        metavar="",
    )
    ...
    optional.add_argument(
        "--output_directory",
        "-o",
        help="the output directory for the dingo-walk output",
        required=False,
        default=None,
        metavar="",
    )
